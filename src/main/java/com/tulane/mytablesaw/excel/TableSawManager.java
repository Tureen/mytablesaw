...
public class TableSawManager {
    ...
    public TableSawManager(Map<String, List<String>> tableTitleIndexs) {
...
//    }
//
//    private static XmlDatasGroup getXmlDatasGroup(Map<Integer, List<XmlResolve.XmlData>> storesGroupByRow) {
